...
module cut_corners(lf,lb,rf,rb) {
	difference() {
		...
		if(lb) translate(v=[(-10)+3,(-28.5/2)+3,0]) rotate(a=[0,0,-45]) 
			rotate(a=[35,0,0]) translate(v=[0,-5,0]) cube(size = [20,10,20], center = true);
		mirror([ 0, 1, 0 ]) {
			if(rf) translate(v=[(10)-3,(-28.5/2)+3,0]) rotate(a=[0,0,45]) 
				rotate(a=[35,0,0]) translate(v=[0,-5,0]) cube(size = [20,10,20], center = true);
			if(rb) translate(v=[(-10)+3,(-28.5/2)+3,0]) rotate(a=[0,0,-45]) 
				rotate(a=[35,0,0]) translate(v=[0,-5,0]) cube(size = [20,10,20], center = true);
		}
	}
}
...
module linear_holder_base(length, width=10) {
	
	difference() {
		union() {
			//main block
			translate(v=[-5,0,length/2]) cube(size = [width,20,length], center = true);
		...
		%translate(v=[0,0,-2]) cylinder(h = length+4, r=8/2, $fn=50);
	...
	translate(v=[0,14.25,4.5]) rotate(a=[90,0,0]) translate(v=[0,9.5,0]) rotate(a=[0,0,90]) {
		...
		difference() {
			union() {
				...
				translate(v=[-10-2,0,lm8uu_holder_length/2]) 
					cube(size = [4,20,lm8uu_holder_length], center = true);
			}
...
module lm8uu_bearing_cut() {
	translate([-lm8uu_holder_width/2,-lm8uu_holder_length/2,-5])
		cube([lm8uu_holder_width,lm8uu_holder_length,20]);
}
